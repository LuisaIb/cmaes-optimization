...
cma_es <- function (x = NULL, fun, lower, upper, 
  ...
  t_evals <- c(100, 500, 1500, 2000, 2500)
  t_iters <- c(50, 500, 1000, 2000)
  t_budget <- c(10, 50, 100, 150, 200)
  t_sigma <- c(10, 50, 100, 250, 500, 1000, 1500)
  t_mu <- c(5, 10, 20, 50, 100)
  t_lambda <- c(5, 10, 20, 30, 40, 50, 60, 70, 100, 150)
...
new_el <- rbind(1500, 2000, 150, 1500, 30, 40)
elements <- cbind(elements, new_el)
...
for(i in 0:9){
  ...
  act_avg <- cbind(act_avg, model$like) 
  
}


avg <- cbind(avg, (sum(act_avg) / length(act_avg)))
...
model <- buildKriging(x,matrix(y,,1),control=list(
        algTheta=cma_es, modelControl = list(target = "ei"), replicateResult = TRUE,
        verbosity=1, plots=TRUE
))
